...
public class Vector2D {
    ...
    @param  x
     @param  y
     @return new vector =oldVector+ passed arguments
     */
    ...
    public  Vector2D substract(float x, float y){ return new Vector2D(this.x-x,this.y-y);}
     ...
     * @return
     */
    public  Vector2D scale(float n){ return  new Vector2D(this.x*n,this.y*n);}
